    ...
    public static class YoutubeDlHelper
    {
        ...
        public static async Task<T> RunYoutubeDl<T>(string path, string args) where T : notnull
        {
            try
            {
                ...
                const string cookiesFile = "/app/data/cookies.txt";

                // Add --cookies argument to the command if the cookies file exists
                ...
                {
                    Log.Warn("Cookies file not found, continuing without it.");
                }
